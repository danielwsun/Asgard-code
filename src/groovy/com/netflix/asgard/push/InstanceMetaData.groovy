...
class InstanceMetaData {
	...
	/* 
	 * Only used for RollingPush mode - Revert to Old LC when instance failure happens
	 * Used to keep track of the previous Slot InstanceState before becoming RevertInit
	 */
