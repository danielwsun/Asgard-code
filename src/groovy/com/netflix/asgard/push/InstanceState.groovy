...
enum InstanceState {
	...
	// Added function: handling instance failure during RollingPush by revert it to OLD LC before relaunch it again
	revertInit       (unlimited()),
	revertTerminated (unlimited()),
	revertPending    (minutes(60)),
	revertReady      (unlimited())
